...
export const steps: Step[] = [
	...
	},
	{
		...
		description:
			'When you commit, fault check --staged runs via the pre-commit hook. It parses every changed file, resolves imports and references, and runs sixteen analyzers in parallel.'
	},
	{
